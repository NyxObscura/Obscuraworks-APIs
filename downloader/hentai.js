/**
 * Downloads hentai content using the ObscuraWorks API.
 *
 * This script fetches media data from a specified hentai Reel URL
 ...
 *
 * @constant {string} url - The complete API URL including the target hentai Reel.
 * @constant {Object} headers - HTTP request headers containing your ObscuraWorks API key.
 *
 * @function fetchhentaiReel
 * @async
...
const url = "https://api.obscuraworks.com/api/downloader/hentai?url=";
