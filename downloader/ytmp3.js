 ...
 *
 * This script retrieves MP3 download links from a specified YouTube URL
 ...
 */
const url = `https://api.obscuraworks.com/api/downloader/ytmp3?url=https://youtu.be/D-Vr8QIPffo?si=CXiFDeSxc7LY_8jY`;
